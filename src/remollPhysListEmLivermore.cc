...
//  exit(0);
  ...
  while( (*particleIterator)() ){
    ...
    // G4double highEnergyLimit = 250*MeV;
    G4double highEnergyLimit = 800*MeV;
...
//      eIoniModel->SetLowEnergyLimit(200*MeV); 
      ...
      eBremModel->SetLowEnergyLimit(0.1*MeV); 
      eBrem->AddEmModel(0, eBremModel);
      pmanager->AddProcess(eBrem,                   -1,-1, 1);
